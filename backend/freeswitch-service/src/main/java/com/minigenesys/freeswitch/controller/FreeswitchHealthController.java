...
public class FreeswitchHealthController {
    ...
    @Autowired
    private FreeswitchEslService eslService;
    ...
    public ResponseEntity<Map<String, Object>> health() {
        ...
        response.put("service", "freeswitch-service");
        ...
        boolean eslConnected = eslService.isConnected();
        components.put("esl", Map.of("status", eslConnected ? "UP" : "DOWN"));
        if (!eslConnected) allUp = false;
    ...
    @GetMapping("/health")
    public ResponseEntity<Map<String, Object>> shortHealth() {
        return health();
    }
